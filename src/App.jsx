...
export default function KetelitianTestWebsite() {
  const questions = [
    {
      id: 1,
    ...
    <div className="min-h-screen bg-gray-100 p-6 flex items-center justify-center">
      <div className="bg-white shadow-2xl rounded-3xl p-8 w-full max-w-2xl">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold">Test Ketelitian Admin Gudang</h1>
        ...
        {!finished ? (
          <div>
            ...
            <button
              ...
              className="mt-6 w-full bg-black text-white py-3 rounded-2xl font-semibold hover:opacity-90 disabled:opacity-50"
            >
              {currentQuestion + 1 === questions.length ? 'Selesai' : 'Next'}
            </button>
          </div>
        ) : (
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4">Test Selesai</h2>
            <p className="text-xl mb-6">Nilai Kandidat:</p>
